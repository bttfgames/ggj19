...
switch(pos){
	case 0:{
		...
		obj_menu.sprite_index = icon_start;
		break;
	}
	case 1:{
		obj_menu_options.image_index = 2;
		obj_menu.sprite_index = icon_about;
		break;
	}
	case 2:{
		obj_menu_options.image_index = 3;
		obj_menu.sprite_index = icon_quit;
		break;
	}
}
...
if (push == 1) {
   ...
   switch (pos) {
	case 0:{
	   ...
	   var game_music = audio_play_sound(sound_game_music, false, true);
